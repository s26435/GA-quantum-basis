...
7. `start_lambda: float` - starting value of lambda - it's weigth of mask part of fitness function <br>$\text{Loss} = E + \lambda \sum^{\text{mask length}}_{n=0}\text{mask}[n]$<br>
